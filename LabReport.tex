...
\begin{tikzpicture}
    \Vertex[x=-1, y=-2]{A}
    \Vertex[x=0]{B} \Vertex[x=2]{C} \Vertex[x=4]{D}
    \Edge(A)(B) \Edge(B)(C) \Edge(C)(D)
    \Vertex[x=8]{E} \Vertex[x=10]{F} \Vertex[x=12]{G}
    \Vertex[x=10, y=-2]{H}
    \Edge(E)(F) \Edge(F)(G) \Edge(F)(H)
    \draw[line width=3pt, -latex](5, -1) -- (7, -1);

	\Vertex[x=2, y=-6]{A}
    \Vertex[x=0, y=-4]{B} \Vertex[x=2, y=-4]{C} \Vertex[x=4,y=-4]{D}
    \Edge(A)(C) \Edge(B)(C) \Edge(C)(D)
    \Vertex[x=8, y=-4]{E} \Vertex[x=10,y=-4]{F} \Vertex[x=12,y=-4]{G}
    \Vertex[x=13, y=-6]{H}
    \Edge(E)(F) \Edge(F)(G) \Edge(G)(H)
    \draw[line width=3pt, -latex](5, -5) -- (7, -5);
\end{tikzpicture}
\caption{拓扑变化图}
\end{figure}
